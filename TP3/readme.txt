...
## Running the game:
This program is coded using Python, so an editor that can run Python scripts is required. Download and unzip the TP3.zip file, as this is the final version. Ensure that the TP3.py and the cmu_112_graphics.py files are both present in the same directory (this should be the case by default). Open the TP3.py file in an editor, and run the script.
